...
## Combine counts from different files in one unique table
...
GSM6160814 <- read_delim("C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/GSM6160814.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)

GSM6160813 <- read_delim("C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/GSM6160813.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)


GSM6160821 <- read_delim("C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/GSM6160821.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)


GSM6160822 <- read_delim("C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/GSM6160822.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)


GSM6160823 <- read_delim("C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/GSM6160823.txt", 
    delim = "\t", escape_double = FALSE, 
    trim_ws = TRUE)
```
## Unite all the correct columns
```{r}
counts.table= c(GSM6160812,GSM6160813[,2],GSM6160814[,2],GSM6160821[,2],GSM6160822[,2],GSM6160823[,2])
...
```{r}
write.table(counts.table, file='C:/Users/Acer/OneDrive/Ambiente de Trabalho/ICVS/Dataset 3/count_table.txt', sep = "\t",col.names = NA)
```
